...
<head>
    ...
    <script src="js/OrderRecord.js" type="text/javascript"></script>
    <style>
        .affix {
            top: 0;
            width: 100%;
...
<nav class="navbar navbar-expand-sm navbar-fixed-top">
    ...
    <form style="text-align:right">
        ...
        <a href="#" action = "https://fisystem.herokuapp.com/Logout?Who=Host" method="post" style="color:#666666"><span class="glyphicon glyphicon-off"></span><strong> 登出</strong></a>
    </form>
</nav>
